...
class equipoform(forms.Form):
    ...
    fecha_adquisicion= forms.DateField(label="Fecha de adquisicion",widget=forms.SelectDateWidget(years=range(1970, 2050)))
    fecha_instalacion= forms.DateField(label="Fecha de instalacion",widget=forms.SelectDateWidget(years=range(1970, 2050)))
