...
urlpatterns = [
    path ('',views.login, name='login'),#Url de inicio en la que podemos elegir entre ser un operario o un responsable
    ...
    path ('responsable/empleado/',views.lista_empleados, name='lista_empleados'),#Url que da la lista de todos los empleados
    path ('responsable/proceso/',views.lista_procesos, name='lista_procesos'),#Url que da la lista de todos los procesos
    ...
    path ('responsable/empleado/<int:empleado_id>', views.detalle_empleado, name="detalleempleado"),#Url de detalles de empleados, desde aqui se puede ir a eliminar y updatear
    path ('responsable/equipo/<int:equipo_id>', views.detalle_equipo, name="detalleequipo"),#Url de detalles de equipo, desde aqui se puede ir a eliminar y updatear
    path ('responsable/proceso/<int:proceso_id>', views.detalle_proceso, name="detalleproceso"),#Url de detalles de proceso, desde aqui se puede ir a eliminar y updatear
    path ('operario/proceso/<int:proceso_id>', views.detalle_procesooperario, name="detalleprocesooperario"),#Url de detalles de proceso, se puede ir a modificar inicio y fin
    path('operario/proceso/update', views.updateprocesooperario, name='updateprocesooperario'),
    path ('operario/post_proceso_update_operario/',views.post_proceso_form_update_operario, name='postprocesoformupdateoperario'),
